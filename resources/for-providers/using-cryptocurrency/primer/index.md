...
last_modified: Wed Jan 21 12:33:43 EST 2026
---
...
As a sex worker, I just want an easy way to pay for things (like [my ads]({% link index.html %}#links-group-ad-listings)) and a private way for my clients and customers to pay me. Unfortunately, if we rely on traditional payment methods, which is often called the "fiat" economy, we are taking on a bunch of additional risks. These risks include:
...
A lot of people who have been in the cryptocurrency space for a while have a lot of [bad information about Zcash](https://maxdesalle.com/mastering-zcash/#8-misconceptions){:target="_blank"}, which stem from an outdated understanding of its technology and app ecosystem.
...
Just like [there are two broad kinds of cryptocurrencies](#two-kinds-of-cryptocurrencies-private-and-not-private) you could use (private or opaque ledger, and not-private or transparent ledger), there are two broad categories of cryptocurrency apps you can use: self-custody (or non-custodial), and third-party (or custodial) crypto apps.
...
**I don't trust third-party custodial "wallet" apps.** I don't have them. I won't use them. I'll never recommend them for sex workers, although clients can still safely use them to pay us. (See [my cryptocurrency guides for clients]({% link resources/for-clients/using-cryptocurrency/index.md %}) to learn more about that side.)
...
I'll talk more about that later when I discuss [wallet app backups and recovery phrases]({% link resources/for-providers/using-cryptocurrency/wallet-apps/index.md %}#backups-and-recovery-phrases), but for now the important thing to know is that unless you're using a self-custody wallet app, you're actually giving the third-party service direct access to your money, just like a regular bank account. This defeats the point of crypto, for me, so I don't really listen to much anyone has to say about them.
