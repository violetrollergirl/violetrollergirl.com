...
Here's a step-by-step guide for what you should do. Many of these steps only have to be done once. After you're set up with these tools and accounts, you can use their "Buy Crypto" feature more easily.
...
>
> **&#9432; This guide presumes you have no existing digital payment services at all.** If you already have a digital payment app that supports cryptocurrency and want to use that one, see...TK.

## In this guide

1. [Install Zashi Wallet](#install-zashi-wallet)
    1. [Optionally enable currency conversion in Zashi](#optionally-enable-currency-conversion-in-zashi)
1. [Buy ZEC with Coinbase Onramp](#buy-zec-with-coinbase-onramp)
    1. [Create your Coinbase account](#create-your-coinbase-account)
    1. [Complete your ZEC purchase via Coinbase](#complete-your-zec-purchase-via-coinbase)
1. [Ask your provider where to send your payment](#ask-your-provider-where-to-send-your-payment)
1. [Send ZEC to your provider](#send-zec-to-your-provider)
...
This is the most frustrating part of the entire set up, but thankfully only needs to be done once. Creating your Coinbase account is a multi-step process that requires you to:

- verify an email and phone number
- submit personal information to Coinbase to verify your legal identity
- connect and confirm your payment method
- upload your legal identity documents

Coinbase requires this because, despite the name of its app, Coinbase is *not* a wallet, but rather a banking service. However, once you purchase ZEC and withdraw it from your Coinbase account to your Zashi wallet, the money you've converted gets automatically disassociated from your legal identity thanks to [Zcash and Zashi's auto-shielding functionality](https://electriccoin.co/blog/new-releases-to-help-enable-zcash-shielded-by-default/){:target="_blank"}.

Coinbase periodically changes their account creation process due to changing financial regulations, however the process is usually completed within ten to thirty minutes and they maintain good documentation:

{:.align-center}
{% include link-as-button.md anchor_text="How to Create a Coinbase Account" url="https://help.coinbase.com/en/coinbase/getting-started/getting-started-with-coinbase/create-a-coinbase-account" target="_blank" %}

You can **follow the on-screen Coinbase Onramp instructions while in Zashi** to create your Coinbase account, or click through the link above to read Coinbase's documentation. Remember that **this step is only needed once** and, when complete, purchasing ZEC and moving it to your Zashi wallet is very smooth.

### Complete your ZEC purchase via Coinbase

Once you complete your [Coinbase set up](#create-your-coinbase-account) or log in, use the Coinbase mobile interface to purchase crypto.
...
Make sure you purchase enough to cover both the price of the service or good you're purchasing as well as Coinbase's service fees, which fluctuate.

If you used Zashi's Coinbase Onramp integration (by accessing the Coinbase screen via Zashi's "Buy ZEC with Coinbase" button), Zashi will now show you a balance in ZEC.

## Ask your provider where to send your payment

Now that you have a balance in ZEC, you need to know where to send this payment so that your provider receives it.
...
- a long string of text that you can copy and paste into your clipboard:
