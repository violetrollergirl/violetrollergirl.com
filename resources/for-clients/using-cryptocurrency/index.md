...
Some of these benefits require you to install what's called a self-custodial wallet app (I like [Zashi Wallet](https://electriccoin.co/zashi/){:target="_blank"} and [Cake Wallet](https://cakewallet.com/){:target="_blank"}) as opposed to using a third-party crypto payment service but, in general, you can just think of cryptocurrency like digital cash, or simply a different kind of foreign currency unit like the Euro or whatever.
...
{:.align-center}
{% include link-as-button.md anchor_text="Crypto Quick(est) Start" url="/resources/for-clients/using-cryptocurrency/quick-start/" %}
...
No stress! Start at my ["Quick(est) Start"]({% link resources/for-clients/using-cryptocurrency/quick-start/index.md %}) guide, which explains how to sign up for the most private of the largest cryptocurrency exchanges, Gemini, where you can buy crypto and make payments.
